...
function MuiAutoComplete(params) {
    ...
    function getSize() {
        ...
        if (ancho < 600 & document.getElementById('btnSearch') != null) {
    ...
    return (
        <div >
            <form style={{ marginLeft: '0.2em', padding: '0.3em' }} onSubmit={submitHandler} id="formAutocomplete" className="form-inline">
                <div className="input-group">
                    <Autocomplete style={{ backgroundColor: 'white' }}
                        ...
                        freeSolo
                    />
                    <button id='btnSearch' type='button' className='btn btn-dark' style={{ color: 'black' }} onClick={buscar}>
