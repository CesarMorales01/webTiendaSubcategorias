...
const ShowByCategory = (params) => {
    ...
    function functionSetProductosSugeridos() {
        if (products.length == 0) {
            ...
            if (num2 > params.allproducts.length) {
                num1 = 0
                num2 = params.allproducts.length
            }
    ...
    return (
        <>
            ...
            <div style={{ margin: '1em' }} className='textAlignCenter'>
                <SuggestedProducts categoria={params.productos.length == 0 ? 'No se han encontrado resultados para ' + params.cate.nombre + '. Que tal estas sugerencias!' : params.cate.nombre.toUpperCase()} productos={products} globalVars={params.globalVars} />
            </div>
