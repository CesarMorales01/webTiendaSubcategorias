...
Route::get('/product/category/{cateorsub}/{id}', [ProductController::class, 'showByCategory'])->name('product.byCategory');
...
Route::get('/nosessioncart', [ShoppingController::class, 'noSessionCart']);
